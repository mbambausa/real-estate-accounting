...
import { getAuthConfig } from "../../../lib/auth"; // Fixed relative path
import type { APIContext } from "astro";
import type { RuntimeEnv } from "../../../env.d"; // Fixed relative path
...
export const onRequest = async (context: APIContext): Promise<Response> => {
  ...
  // Use the globally available App namespace without import
  ...
  try {
    ...
    // Cast to standard Response to fix type compatibility issue
